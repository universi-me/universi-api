...
public class GroupEmailFilterController {
    ...
    @ResponseBody
    public ResponseEntity<Boolean> email_filter_delete( @Valid @PathVariable @NotNull( message = "ID do filtro inválido" ) UUID id ) {
        return ResponseEntity.ok( groupEmailFilterService.deleteEmailFilter( id ) );
    }
